package com.example.mdjahirulislam.final_project_bitm.sharePreference;
...
public class UserSharePreference {
    ...
    private static final String POST_UNIQUE_ID ="post_unique_id";
    ...
    public boolean setPostUniqueId(String postID){

        editor.putString(POST_UNIQUE_ID,postID);
        editor.commit();
        if (POST_UNIQUE_ID.isEmpty()){
            return false;
        }else {
            return true;
        }
    ...
    public String getPostUniqueId() {
        return sharedPreferences.getString(POST_UNIQUE_ID,DEFAULT_MSG);
    }
